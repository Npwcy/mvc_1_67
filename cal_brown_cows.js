...
async function handleMilkProduction(action){
    ...
    if(!cow){
        ...
        milkOutputElement.textContent = 'chocolate milk 1 bottle';
    }else if(cow.color === 'white') {
        errorElement.textContent = 'This is brown cows';
        milkOutputElement.textContent = '';
    }
}

document.getElementById('makeMilkButton').addEventListener('click', handleMilkProduction);
